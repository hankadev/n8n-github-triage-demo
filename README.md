...
- Issue is simple and well-defined
- Easy for new contributors (styling, copy changes, small fixes)
- Priority is NOT high (low and some medium issues are eligible)
...
- **Import the n8n workflow** (workflow file to be provided separately)
...
- **Configure the cron trigger** for daily execution
- **Test the workflow** using the manual trigger option

### Repository Configuration

Ensure your repository has the following labels created:
- `needs-triage`
- `bug`
- `enhancement`
- `question`
...
│   └── before-running-workflow.png     # Screenshot showing workflow state
└── .github/
    └── workflows/
